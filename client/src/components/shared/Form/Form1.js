     ...
     if (!email) {
      ...
      if (phone.trim() === "") {
        ...
        if (!phoneRegex.test(phone)) {
          formErrors.phone = "Phone must contain 10 digits";
        }
      }
      
      if(!website) formErrors.website = "Website is required";
 
      if(!organisationName)   formErrors.organisationName="Organisation is required";
  
      if(!address) formErrors.address="Address is required";

      if(!hospitalName)  formErrors.hospitalName="Hospital is required";
